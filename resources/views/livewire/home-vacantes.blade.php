<div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white shadow-sm rouded-lg p-6 divide-y divide-gray-200">
                @forelse ($vacantes as $vacante)
                    <div class="md:flex md:justify-between md:items-center py-5">
                            <div class="md:flex-1">
                                ...
                                <p class="font-extrabold text-xs text-gray-600">Último dia para postularse: 
                ...
                @empty
                    <p class="p-3 text-center text-sm text-gray-600">No hat vacantes aún</p>
                @endforelse
            </div>
        </div>
    </div>
